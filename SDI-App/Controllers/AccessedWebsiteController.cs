...
namespace SDI_App.Controllers
{
    ...
    public class AccessedWebsiteController : ControllerBase
    {
        ...
        public async Task<IActionResult> PostAccessedWebsite(AddAwDTO addAwDTO)
        {
            ...
            var AccessedWebsite = _mapper.Map<AccessedWebsite>(addAwDTO);
            await _repo.Add(AccessedWebsite);

            return Created(nameof(GetAccessedWebsiteById), _mapper.Map<AwShortDTO>(AccessedWebsite));
        }
